...
> Also responds if you use https://dontquotetheai.com | I was very rushy when
> getting the domain
...
> **Don't see your language?** Translations are how this page helps people. The whole process is in [TRANSLATING.md](TRANSLATING.md), you don't need to touch hreflang or render PNGs, CI handles both. Just translate the text and open a PR.
